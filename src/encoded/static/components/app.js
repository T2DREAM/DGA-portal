    ...
    global_sections: [
        {
            ...
            children: [
                ...
                { id: 'contact', title: 'Contact', url: '/acknowledgements/' },
            ],
        },
        {
            id: 'data',
...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        this.lock = new Auth0Lock('0Ht3cCS1Rr5dlptrK1w3PU7O0r2p0fB4', 't2depi.auth0.com', {
            auth: {
                responseType: 'token',
                redirect: false,
        ...
        this.lock.on('signin ready', () => {
            ...
            if (lockElements && lockElements.length) {
                ...
                privacyLink.href = 'https://ucsd.edu/about/privacy-policy.html';
                privacyLink.title = 'View University of San Diego privacy policy';
    ...
    render() {
        ...
        let base;
        if (({ 'https://diabetesepigenome.org/': 1, 'http://diabetesepigenome.org': 1 })[canonical]) {
