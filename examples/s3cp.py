...
AUTHID='user'; AUTHPW='secret'; HEADERS = {'content-type': 'application/json'}; SERVER = 'https://www.diabetesepigenome.org'
S3_SERVER='s3://t2depi-files/'

#get all the file objects
files = requests.get(
    'https://www.diabetesepigenome.org/search/?type=file&frame=embedded&limit=all',
